...
type MsgSeismicSidecar struct {
	EnclaveSig string `protobuf:"bytes,1,opt,name=enclave_sig,json=enclaveSig,proto3" json:"enclave_sig,omitempty"`
}

func (m *MsgSeismicSidecar) Reset()         { *m = MsgSeismicSidecar{} }
func (m *MsgSeismicSidecar) String() string { return proto.CompactTextString(m) }
func (*MsgSeismicSidecar) ProtoMessage()    {}
func (*MsgSeismicSidecar) Descriptor() ([]byte, []int) {
	return fileDescriptor_288b272163299061, []int{4}
}
func (m *MsgSeismicSidecar) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSeismicSidecar) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSeismicSidecar.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSeismicSidecar) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSeismicSidecar.Merge(m, src)
}
func (m *MsgSeismicSidecar) XXX_Size() int {
	return m.Size()
}
func (m *MsgSeismicSidecar) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSeismicSidecar.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSeismicSidecar proto.InternalMessageInfo

func (m *MsgSeismicSidecar) GetEnclaveSig() string {
	if m != nil {
		return m.EnclaveSig
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgSeismicSidecar)(nil), "octane.evmengine.types.MsgSeismicSidecar")
}
...
var fileDescriptor_288b272163299061 = []byte{
	...
	,
}
...
func (m *MsgSeismicSidecar) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSeismicSidecar) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSeismicSidecar) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EnclaveSig) > 0 {
		i -= len(m.EnclaveSig)
		copy(dAtA[i:], m.EnclaveSig)
		i = encodeVarintTx(dAtA, i, uint64(len(m.EnclaveSig)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgSeismicSidecar) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSeismicSidecar) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSeismicSidecar: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSeismicSidecar: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnclaveSig", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnclaveSig = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
